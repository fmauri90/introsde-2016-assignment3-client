 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://ws.soap.assignment.introsde/", wsdlLocation = "https://sleepy-falls-14531.herokuapp.com/ws/people?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://sleepy-falls-14531.herokuapp.com/ws/people?wsdl");
